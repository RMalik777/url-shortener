		...
		>
			...
			>
				...
				<ul className="mb-6 space-y-3">
					...
					{todos.length === 0 && (
						<li className="py-8 text-center text-indigo-300/70">No todos yet. Create one below!</li>
					)}
				</ul>
				...
				>
					...
					<div className="space-y-2 text-sm">
						...
						<ol className="list-inside list-decimal space-y-2 text-indigo-300/80">
							<li>
								Configure your{" "}
								<code className="rounded bg-black/30 px-2 py-1 text-purple-300">DATABASE_URL</code>{" "}
								in .env.local
							</li>
							<li>
								Run:{" "}
